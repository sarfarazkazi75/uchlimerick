        ...
        <div class="row text-border-bottom">
            ...
            <div class="col-lg-6 col-md-6 d-lg-block d-md-block d-none">
                <div class="all-project-btn">
                    <?php if($view_post_link != ""): ?><a href="<?php echo $view_post_link['url'];?>" class="bg-transparent button"><?php echo $view_post_link['title']; ?></a><?php endif; ?>
                </div>
            </div>
                ...
                foreach($recent_posts as $post) : ?>
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="project-des"><a href="#" class="project-card">
                            ...
                            </a><a href="<?php get_the_permalink(); ?>" class="read-btn">Read more <img src="https://dddemo.net/wordpress/2022/uchlimerick/wp-content/themes/uchlimerick/assets/images/righ-chevrow-yellow.svg" alt=""></a>
                        </div>          
                    </div>
