    ...
    <div class="container-inner">
            ...
            <div class="col-lg-6 col-md-6 d-lg-block d-md-block d-none">
                <div class="all-project-btn">
                    <?php if($view_post_link != ""): ?><a href="<?php echo $view_post_link['url'];?>"
                        target="<?php echo $view_post_link['target'];?>"
        ...
        <div class="row card-slider-row">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="<?php get_the_permalink($post["ID"]); ?>" class="project-card" target="blank">
                    <div class="card-img">
                        <?php echo get_the_post_thumbnail($post["ID"]) ?>
                    </div>
                </a>
                <div class="project-des"><a href="<?php echo get_the_permalink($post["ID"]); ?>" class="project-card"
                        target="blank">
                        <h6><?php echo get_the_title($post["ID"]) ?> </h6>
                    </a><a href="<?php echo get_the_permalink($post["ID"]); ?>" class="read-btn"><?php echo _('Read more');?> <img
